	...
	while(mejora)
	{
		...
		for(int i = 0 ; i < iters ; i++)
		{
			...
			{			
				...
				float sol = funcion_objetivo(training, solucion_tmp);
...
int main()
{
	...
	for(int i = 1 ; i <= 5 ; i++)
	{
		...
		start_timers();
		SFS(solucion_wdbc_promedio, solucion_wdbc, submuestra_wdbc1);
		...
		start_timers();
		SFS(solucion_wdbc_promedio, solucion_wdbc, submuestra_wdbc2);
		time = elapsed_time();
	...
	for(int i = 1 ; i <= 5 ; i++)
	{
		...
		start_timers();
		SFS(solucion_movement_promedio, solucion_movement, submuestra_movement1);
		double time = elapsed_time();
		...
		start_timers();
		SFS(solucion_movement_promedio, solucion_movement, submuestra_movement2);
		time = elapsed_time();
	...
	for(int i = 1 ; i <= 5 ; i++)
	{
		...
		start_timers();
		SFS(solucion_arrhytmia_promedio, solucion_arrhytmia, submuestra_arrhythmia1);
		double time = elapsed_time();
		...
		start_timers();
		SFS(solucion_arrhytmia_promedio, solucion_arrhytmia, submuestra_arrhythmia2);
		time = elapsed_time();
		cout << "hola " << endl;
